...
| `agent` | Full ticket-handler workflow + KB lookups + custom-field introspection (default) | 23 |
| `knowledge` | KB-author workflow + incident reads + custom-field introspection | 12 |
| `full` | Every tool | 25 |
